...
class BOOK_HANDLER_QUERIES:
    ...
    INSERT_BOOK = "INSERT INTO books (access_number, call_number, title, author, status, qr_code_path) VALUES (%s, %s, %s, %s, %s, %s)"
...
class RECORD_QUERIES:
    SELECT_COPIES_AVAILABLE = """
    SELECT title, author, COUNT(*) AS copy_count
    FROM books
